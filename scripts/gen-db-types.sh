...
# competitor_intel joined in Wave 8 (2026-08-08-w8-competitor-intel.sql).
SCHEMAS="marketinghub,competitor_intel,public,storage,vault"
...
grep -q "match_chunks" "$TMP_TYPES" || die "generated output missing competitor_intel surfaces (Wave 8) — refusing to write"
